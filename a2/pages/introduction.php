...
<html lang='en'>
    ...
    <meta name="author" content="Alanna Hembrow">
	  ...
	  <link id='stylecss' type="text/css" rel="stylesheet" href="../../a2/css/introduction-stylesheet.css">
            ...
            <h2>Abbreviations and Terms</h2>
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Wet Canteen</td>
                    <td>Bar and/or cafeteria, etc. Where alcohol is served</td>
                  </tr>
                  <tr>
                    <td>Sapping</td>
                    <td>Digging a tunnel or deep trench to approach or undermine an enemy</td>
                  </tr>
                  <tr>
                    <td>L. horse</td>
                    <td>Light Horse.</td>
                  ...
                  <tr>
                    <td>Bomb</td>
                    <td>Unless dropped from an aeroplane these would have been Mills Bombs</td>
                  </tr>
                  <tr>
                    <td>Blighty</td>
                    <td>England</td>
